...
import { PlatformPills } from "./landing-illustrations";

export function FinalCta() {
  return (
    <section className="landing-section px-5 py-20">
      <div className="mx-auto w-full max-w-7xl">
        <div className="landing-glass relative overflow-hidden rounded-lg px-6 py-16 text-center sm:px-12">
          <div
            aria-hidden
