...
const STORE = {
  ios: "https://apps.apple.com/search?term=Stillora",
  mac: "https://apps.apple.com/search?term=Stillora",
  android: "https://play.google.com/store/search?q=Stillora&c=apps",
  windows: "https://apps.microsoft.com/search?query=Stillora",
  linux: "https://flathub.org/apps/search?q=Stillora",
};
...
const RATIOS = [
  { id: "9:16", css: "9 / 16", img: "/stillora/format-9x16.png" },
  { id: "4:5", css: "4 / 5", img: "/stillora/format-4x5.png" },
  { id: "1:1", css: "1 / 1", img: "/stillora/format-1x1.png" },
  { id: "16:9", css: "16 / 9", img: "/stillora/format-16x9.png" },
];
...
const CLIPS = ["/stillora/clip-1.png", "/stillora/clip-2.png", "/stillora/clip-3.png"];
...
export default function StilloraLanding() {
  ...
  const stores = [
    { k: "mac", href: STORE.mac },
    { k: "ios", href: STORE.ios },
    { k: "android", href: STORE.android },
    { k: "windows", href: STORE.windows },
    { k: "linux", href: STORE.linux },
  ];
  ...
  return (
    <div
      ...
      dir={dir}
      lang={locale}
      style={arabic ? { fontFamily: "'Noto Kufi Arabic', 'DM Sans', system-ui, sans-serif" } : undefined}
    >
